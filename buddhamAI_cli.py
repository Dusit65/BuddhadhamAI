...
try:
    ...
    def ask_cli(argv=None):
        ...
        time.sleep(0)
        # result = {"answer": "**อะฮิอะฮิอะฮอว์ (อะฮิอะฮอว์)**  \nอะฮิอะฮิอะฮอว์คือ “อะฮิอะฮอว์” หรือ **อริยสัจที่สี่** เป็นทางที่พระพุทธเจ้าสอนเพื่อดับทุกข์ โดยแบ่งออกเป็น **องค์ประกอบ 8 ส่วน** (อริยมหามรรค) ดังนี้  \n\n| สัมมนะ | รายละเอียด | ความหมายโดยสังเขป |\n|--------|------------|--------------------|\n| **ความถูกต้องของความคิด (สัมมาทิฐิ)** | ความเข้าใจในความจริงของทุกข์ สมุทัย นิโรธ และมรรค | เริ่มต้นด้วยการรับรู้ความเป็นจริงของชีวิต |\n| **ความถูกต้องของเจตนา (สัมมาสังกัปปะ)** | เจตนาที่ปราศจากพฤติกรรมกิริยาไม่ดี (เช่น อยาก, ก้าวร้าว) | เปลี่ยนใจให้กลายเป็นใจที่ดี |\n| **คำพูดที่ถูกต้อง (สัมมาวาจ)** | พูดจริง ไม่โกหก ไม่พูดคำอันเลวร้าย | ปลูกฝังความจริงในสังคม |\n| **การกระทำที่ถูกต้อง (สัมมาทัตฺว)** | ทำตามกฎศีล ไม่ทำร้ายผู้อื่น | ลดปัจจัยทำให้เกิดทุกข์ |\n| **วิถีชีวิตที่ถูกต้อง (สัมมาวิญญา)** | เลือกอาชีพที่ไม่ทำให้ความทุกข์ | การทำงานให้เป็นประโยชน์ |\n| **พยายามที่ถูกต้อง (สัมมาทิปปาน)** | มีความพยายามต่อการฝึกปฏิบัติ | การรักษาต่อเนื่อง |\n| **ความตั้งใจที่ถูกต้อง (สัมมาสติ)** | การระลึกถึงการกระทำในปัจจุบัน | ฝึกสติให้ตระหนักถึงความสำคัญ |\n| **ความสติที่ถูกต้อง (สัมมาสมาธิ)** | การพัฒนาจิตให้สงบ มีสมาธิ | ทำให้จิตสบายและเข้าใจจริงจัง |\n\n**สรุป**  \nมรรคเป็นเส้นทางที่นำพาให้เราตระหนักถึงสาเหตุของความทุกข์ (สมุทัย) และปฏิบัติเพื่อดับทุกข์ (นิโรธ) ผ่านการฝึกปฏิบัติตามหลัก 8 ส่วนนี้ การทำตามมรรคจึงเป็นวิธีปฏิบัติหลักของพระพุทธศาสนาในการบรรลุความสุขแท้และความนิรันดร์.", "argv": message, "references": "ไม่มี", "duration": format_duration(0)} # for test only
